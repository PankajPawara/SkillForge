    ...
    return (
        <div className="max-w-7xl mx-auto p-4">
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                {/* Lecture Sidebar  */}
                <div className="flex flex-col w-[200px] md:w-2/5 border-t md:border-t-0 md:border-l border-gray-200 md:pl-4 pt-4 md:pt-0">
                    <h2 className="font-semibold text-xl mb-4">Course Lecture</h2>
                    <ScrollArea className="h-[550px] w-[400px] rounded-md border vertical">
